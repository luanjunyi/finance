...
def trading_test_db():
    ...
    conn.executemany(
        """INSERT INTO income_statement (
            ...
            net_income, eps, eps_diluted, weighted_average_shares_outstanding_diluted
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)""",
        [
            # AAPL quarterly data - 2023
            ('AAPL', '2023-10-01', 'Q', '2023', 'USD', 120e9, 60e9, 60e9, 36e9, 30e9, 3.0, 2.9, 10),
            ('AAPL', '2023-07-01', 'Q', '2023', 'USD', 115e9, 57.5e9, 57.5e9, 34.5e9, 28.75e9, 2.9, 2.8, 100),
            ('AAPL', '2023-04-01', 'Q', '2023', 'USD', 110e9, 55e9, 55e9, 33e9, 27.5e9, 2.8, 2.7, 1000),
            ('AAPL', '2023-01-01', 'Q', '2023', 'USD', 105e9, 52.5e9, 52.5e9, 31.5e9, 26.25e9, 2.7, 2.6, 10000),
            
            # AAPL quarterly data - 2022
            ('AAPL', '2022-10-01', 'Q', '2022', 'USD', 100e9, 50e9, 50e9, 30e9, 25e9, 2.6, 2.5, 3210),
            ('AAPL', '2022-07-01', 'Q', '2022', 'USD', 95e9, 47.5e9, 47.5e9, 28.5e9, 23.75e9, 2.5, 2.4, 190230),
            ('AAPL', '2022-04-01', 'Q', '2022', 'USD', 90e9, 45e9, 45e9, 27e9, 22.5e9, 2.4, 2.3, 10392023),
            ('AAPL', '2022-01-01', 'Q', '2022', 'USD', 85e9, 42.5e9, 42.5e9, 25.5e9, 21.25e9, 2.3, 2.2, 13290320),
            
            # MSFT quarterly data - 2023
            ('MSFT', '2023-10-01', 'Q', '2023', 'USD', 58e9, 23.2e9, 34.8e9, 23.2e9, 17.4e9, 3.2, 3.1, 8),
            ('MSFT', '2023-07-01', 'Q', '2023', 'USD', 56e9, 22.4e9, 33.6e9, 22.4e9, 16.8e9, 3.15, 3.05, 801212),
            ('MSFT', '2023-04-01', 'Q', '2023', 'USD', 54e9, 21.6e9, 32.4e9, 21.6e9, 16.2e9, 3.1, 3.0, 18332),
            ('MSFT', '2023-01-01', 'Q', '2023', 'USD', 52e9, 20.8e9, 31.2e9, 20.8e9, 15.6e9, 3.05, 2.95, 8128),
            
            # MSFT quarterly data - 2022
            ('MSFT', '2022-10-01', 'Q', '2022', 'USD', 50e9, 20e9, 30e9, 20e9, 15e9, 3.0, 2.9, 811),
            ('MSFT', '2022-07-01', 'Q', '2022', 'USD', 48e9, 19.2e9, 28.8e9, 19.2e9, 14.4e9, 2.95, 2.85, 89012),
            ('MSFT', '2022-04-01', 'Q', '2022', 'USD', 46e9, 18.4e9, 27.6e9, 18.4e9, 13.8e9, 2.9, 2.8, 8912),
            ('MSFT', '2022-01-01', 'Q', '2022', 'USD', 44e9, 17.6e9, 26.4e9, 17.6e9, 13.2e9, 2.85, 2.75, 1389),
            
            # GOOGL quarterly data - 2023
            ('GOOGL', '2023-10-01', 'Q', '2023', 'USD', 76e9, 34.2e9, 41.8e9, 26.6e9, 21.28e9, 4.8, 4.7, 6),
            ('GOOGL', '2023-07-01', 'Q', '2023', 'USD', 74e9, 33.3e9, 40.7e9, 25.9e9, 20.72e9, 4.6, 4.5, 2323),
            ('GOOGL', '2023-04-01', 'Q', '2023', 'USD', 72e9, 32.4e9, 39.6e9, 25.2e9, 20.16e9, 4.4, 4.3, 322),
            ('GOOGL', '2023-01-01', 'Q', '2023', 'USD', 70e9, 31.5e9, 38.5e9, 24.5e9, 19.6e9, 4.2, 4.1, 89236),
            
            # GOOGL quarterly data - 2022
            ('GOOGL', '2022-10-01', 'Q', '2022', 'USD', 68e9, 30.6e9, 37.4e9, 23.8e9, 19.04e9, 4.0, 3.9, 26),
            ('GOOGL', '2022-07-01', 'Q', '2022', 'USD', 66e9, 29.7e9, 36.3e9, 23.1e9, 18.48e9, 3.8, 3.7, 690232),
            ('GOOGL', '2022-04-01', 'Q', '2022', 'USD', 64e9, 28.8e9, 35.2e9, 22.4e9, 17.92e9, 3.6, 3.5, 6290323),
            ('GOOGL', '2022-01-01', 'Q', '2022', 'USD', 62e9, 27.9e9, 34.1e9, 21.7e9, 17.36e9, 3.4, 3.3, 23903236)
        ]
    )
    
    # Insert sample balance sheet data with simplified values
    conn.executemany(
        ...
        [
            # AAPL balance sheet data - 2023
            ('AAPL', '2023-10-01', 'Q', '2023', 'USD', 100, 50),
            ('AAPL', '2023-07-01', 'Q', '2023', 'USD', 330, 30),
            ('AAPL', '2023-04-01', 'Q', '2023', 'USD', 220, 20),
            ('AAPL', '2023-01-01', 'Q', '2023', 'USD', 110, 10),
            
            # AAPL balance sheet data - 2022
            ('AAPL', '2022-10-01', 'Q', '2022', 'USD', 100, 50),
            ('AAPL', '2022-07-01', 'Q', '2022', 'USD', 330.112, 922),
            ('AAPL', '2022-04-01', 'Q', '2022', 'USD', 220.32, 323),
            ('AAPL', '2022-01-01', 'Q', '2022', 'USD', 113, 1212),
            
            # MSFT balance sheet data - 2023
            ('MSFT', '2023-10-01', 'Q', '2023', 'USD', 60, 30),
            ('MSFT', '2023-07-01', 'Q', '2023', 'USD', 6032, 323),
            ('MSFT', '2023-04-01', 'Q', '2023', 'USD', 609922, 223),
            ('MSFT', '2023-01-01', 'Q', '2023', 'USD', 6012, 123),
            
            # MSFT balance sheet data - 2022
            ('MSFT', '2022-10-01', 'Q', '2022', 'USD', 60, 30),
            ('MSFT', '2022-07-01', 'Q', '2022', 'USD', 6032, 323),
            ('MSFT', '2022-04-01', 'Q', '2022', 'USD', 603222, 223),
            ('MSFT', '2022-01-01', 'Q', '2022', 'USD', 60122323, 320023),
            
            # GOOGL balance sheet data - 2023
            ('GOOGL', '2023-10-01', 'Q', '2023', 'USD', 150, 30),
            ('GOOGL', '2023-07-01', 'Q', '2023', 'USD', 1502323, 30),
            ('GOOGL', '2023-04-01', 'Q', '2023', 'USD', 15230, 30432),
            ('GOOGL', '2023-01-01', 'Q', '2023', 'USD', 15023, 332420),
            
            # GOOGL balance sheet data - 2022
            ('GOOGL', '2022-10-01', 'Q', '2022', 'USD', 150, 30),
            ('GOOGL', '2022-07-01', 'Q', '2022', 'USD', 1502323, 30),
            ('GOOGL', '2022-04-01', 'Q', '2022', 'USD', 152223230, 3.32),
            ('GOOGL', '2022-01-01', 'Q', '2022', 'USD', 3250, 98230)
        ]
    )
