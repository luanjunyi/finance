...
def trading_test_db():
    ...
    conn.executemany(
        ...
        [
            # AAPL metrics - 2023
            ('AAPL', '2023-10-01', 2023, 'Q', 12.5, 3.0, 4.2, 3.6, 32.0, 0.09375),
            ('AAPL', '2023-07-01', 2023, 'Q', 12.0, 2.875, 4.025, 3.45, 31.5, 0.09127),
            ('AAPL', '2023-04-01', 2023, 'Q', 11.5, 2.75, 3.85, 3.3, 31.0, 0.08871),
            ('AAPL', '2023-01-01', 2023, 'Q', 11.0, 2.625, 3.675, 3.15, 30.5, 0.08607),
            
            # AAPL metrics - 2022
            ('AAPL', '2022-10-01', 2022, 'Q', 10.5, 2.5, 3.5, 3.0, 30.0, 0.08333),
            ('AAPL', '2022-07-01', 2022, 'Q', 10.0, 2.375, 3.325, 2.85, 29.5, 0.08051),
            ('AAPL', '2022-04-01', 2022, 'Q', 9.5, 2.25, 3.15, 2.7, 29.0, 0.07759),
            ('AAPL', '2022-01-01', 2022, 'Q', 9.0, 2.125, 2.975, 2.55, 28.5, 0.07456),
            
            # MSFT metrics - 2023
            ('MSFT', '2023-10-01', 2023, 'Q', 7.0, 2.175, 2.9, 2.465, 25.5, 0.08529),
            ('MSFT', '2023-07-01', 2023, 'Q', 6.75, 2.1, 2.8, 2.38, 25.0, 0.084),
            ('MSFT', '2023-04-01', 2023, 'Q', 6.5, 2.025, 2.7, 2.295, 24.5, 0.08265),
            ('MSFT', '2023-01-01', 2023, 'Q', 6.25, 1.95, 2.6, 2.21, 24.0, 0.08125),
            
            # MSFT metrics - 2022
            ('MSFT', '2022-10-01', 2022, 'Q', 6.0, 1.875, 2.5, 2.125, 23.5, 0.07979),
            ('MSFT', '2022-07-01', 2022, 'Q', 5.75, 1.8, 2.4, 2.04, 23.0, 0.07826),
            ('MSFT', '2022-04-01', 2022, 'Q', 5.5, 1.725, 2.3, 1.955, 22.5, 0.07667),
            ('MSFT', '2022-01-01', 2022, 'Q', 5.25, 1.65, 2.2, 1.87, 22.0, 0.075),
            
            # GOOGL metrics - 2023
            ('GOOGL', '2023-10-01', 2023, 'Q', 12.5, 3.55, 4.81, 3.93, 28.0, 0.12679),
            ('GOOGL', '2023-07-01', 2023, 'Q', 12.0, 3.45, 4.69, 3.82, 27.5, 0.12545),
            ('GOOGL', '2023-04-01', 2023, 'Q', 11.5, 3.36, 4.56, 3.72, 27.0, 0.12444),
            ('GOOGL', '2023-01-01', 2023, 'Q', 11.0, 3.27, 4.43, 3.62, 26.5, 0.12340),
            
            # GOOGL metrics - 2022
            ('GOOGL', '2022-10-01', 2022, 'Q', 10.5, 3.17, 4.31, 3.51, 26.0, 0.12192),
            ('GOOGL', '2022-07-01', 2022, 'Q', 10.0, 3.08, 4.18, 3.41, 25.5, 0.12078),
            ('GOOGL', '2022-04-01', 2022, 'Q', 9.5, 2.99, 4.05, 3.31, 25.0, 0.1196),
            ('GOOGL', '2022-01-01', 2022, 'Q', 9.0, 2.89, 3.93, 3.2, 24.5, 0.11796)
        ]
    )
